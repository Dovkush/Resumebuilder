...
function mapStoretoProps(store){
  return {document:store.document,contact:store.contact,education:store.education};
}

  function mapDispatchtoProps(dispatch){
    return {
      setEducationDetails:(educationdetails)=>{
            dispatch({type:actionTypes.SET_EDUCATION_DETAILS,payload:educationdetails});
      }
    }
  }


export default withRouter(connect(mapStoretoProps,mapDispatchtoProps)(Education));
